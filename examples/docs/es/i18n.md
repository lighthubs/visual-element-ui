...
import locale from 'visual-element-ui/lib/locale/lang/en'
...
import lang from 'visual-element-ui/lib/locale/lang/en'
import locale from 'visual-element-ui/lib/locale'
...
{
  plugins: [
    new webpack.NormalModuleReplacementPlugin(/visual-element-ui[\/\\]lib[\/\\]locale[\/\\]lang[\/\\]zh-CN/, 'visual-element-ui/lib/locale/lang/en')
  ]
}
```
...
import enLocale from 'visual-element-ui/lib/locale/lang/en'
import zhLocale from 'visual-element-ui/lib/locale/lang/zh-CN'
...
import enLocale from 'visual-element-ui/lib/locale/lang/en'
import zhLocale from 'visual-element-ui/lib/locale/lang/zh-CN'
import ElementLocale from 'visual-element-ui/lib/locale'
...
<script src="//unpkg.com/visual-element-ui"></script>
<script src="//unpkg.com/visual-element-ui/lib/umd/locale/en.js"></script>
...
<script src="//unpkg.com/visual-element-ui"></script>
<script src="//unpkg.com/visual-element-ui/lib/umd/locale/zh-CN.js"></script>
<script src="//unpkg.com/visual-element-ui/lib/umd/locale/en.js"></script>
