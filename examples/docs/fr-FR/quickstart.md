...
```javascript
import Vue from 'vue';
import ElementUI from 'visual-element-ui';
import 'visual-element-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'visual-element-ui';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'visual-element-ui';
