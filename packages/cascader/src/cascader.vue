...
<script>
import Popper from 'visual-element-ui/src/utils/vue-popper';
import Clickoutside from 'visual-element-ui/src/utils/clickoutside';
import Emitter from 'visual-element-ui/src/mixins/emitter';
import Locale from 'visual-element-ui/src/mixins/locale';
import Migrating from 'visual-element-ui/src/mixins/migrating';
import ElInput from 'visual-element-ui/packages/input';
import ElTag from 'visual-element-ui/packages/tag';
import ElScrollbar from 'visual-element-ui/packages/scrollbar';
import ElCascaderPanel from 'visual-element-ui/packages/cascader-panel';
import AriaUtils from 'visual-element-ui/src/utils/aria-utils';
import { t } from 'visual-element-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'visual-element-ui/src/utils/util';
import { isUndefined, isFunction } from 'visual-element-ui/src/utils/types';
import { isDef } from 'visual-element-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'visual-element-ui/src/utils/resize-event';
