...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'visual-element-ui/src/utils/date-util';
  import { hasClass } from 'visual-element-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'visual-element-ui/src/utils/util';
