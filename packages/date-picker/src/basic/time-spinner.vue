...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'visual-element-ui/src/utils/date-util';
  import ElScrollbar from 'visual-element-ui/packages/scrollbar';
  import RepeatClick from 'visual-element-ui/src/directives/repeat-click';
